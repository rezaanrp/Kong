...
namespace MIS
{
    public partial class frmEmpty_Report : Form
    {
        ...
        private Stack<string> stackSizeParamName = new Stack<string>();
        private Stack<int> stackSizeParamValue = new Stack<int>();
        ...
        public void SetParamSize(string Name, int Value)
        {
            stackSizeParamName.Push(Name);
            stackSizeParamValue.Push(Value);
        }
        ...
        void Generate()
        {
            ...
            while (stackSizeParamName.Count > 0)
            {
                dataGridView1.Columns[stackSizeParamName.Pop()].Width = stackSizeParamValue.Pop();
            }
