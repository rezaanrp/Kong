...
namespace MIS
{
    public partial class Main : Form
    {
        ...
        void CheakWorkYear()
        {
            if (MIS.Properties.Settings.Default.WorkYear.Substring(0, 4) != BLL.csshamsidate.shamsidate.Substring(0, 4))
            {
                MessageBox.Show("سال کاری  " + " " + MIS.Properties.Settings.Default.WorkYear.Substring(0, 4) + " " + "تنظیم شده ");
            }
        ...
        void Generate()
        {
            ...
            while (Stack_tree.Count != 0)
            {
                ...
                drR = dt_D.Select("xParent_ = " + S_tr.Tag, "xOrder ASC");
                foreach (DataRow item in drR)
                {
        ...
        {
            lbl_Date.Text = new BLL.csshamsidate().shamsidatAndDayOFWeek();
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (xPopTime > 1000)
            {
                if (new BLL.GenGroup.csGenGroup().SlGenGroup("CLOSEMIS").Rows[0]["xName"].ToString() == "1")
                    Application.Exit();
                FrmPopUp(); xPopTime = 0;
            }
        ...
        private void Main_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (e.CloseReason == CloseReason.UserClosing)
            {
                ...
                this.Hide();
                notifyIcon1.ShowBalloonTip(1000, "", "جهت مشاهده برنامه بر روی این ایکون کلیک کنید", ToolTipIcon.None);
        ...
        private void treeView1_NodeMouseDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            if (int.Parse(e.Node.Tag.ToString()) > 0)
            {
                ...
                MIS.Properties.Settings.Default.TreeviewOrder = tt;
                MIS.Properties.Settings.Default.Save();
                ...
                if (dr != null)
                {
                    Properties.Settings.Default.LsfEn = dr["xObjectname"].ToString();
                    Properties.Settings.Default.LsfFa = dr["xObjectFarsiName"].ToString();
                    Properties.Settings.Default.Save();
        ...
        void VisibleRightPanel()
        {
            foreach (Control item in splitContainer1.Panel1.Controls.OfType<Control>())
            {
                ...
                Properties.Settings.Default.LsfEn = st;
                //  Properties.Settings.Default.LsfFa = ((System.Windows.Forms.ToolStripItem)(sender)).Text;
                Properties.Settings.Default.Save();
                ...
                if (BLL.authentication.objectallow("ClientReferral_MoonReport"))
                {
                   // Chart1();
                  //  Chart2();
                   // chart5.Visible = true;
        ...
        private void btna_AccessRights_Click(object sender, EventArgs e)
        {
            ...
            new MIS.FRM.AccessRights.frmAccessRightTree().ShowDialog();
        ...
        {
            new MIS.FRM.EditObjectGroup.frmEditObjectGroup().ShowDialog();
