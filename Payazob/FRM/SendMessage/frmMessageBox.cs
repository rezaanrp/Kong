...
namespace MIS.FRM.SendMessage
{
    public partial class frmMessageBox : Form
    {
        ...
        void ShowRec(bool isNext,bool isFirst)
        {
            ...
            dataGridView1.Columns["xFileName"].Visible = false;
            dataGridView1.Columns["xFileId_"].Visible = false;
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            richTextBox1.Text = sb.ToString();
            if (dataGridView1["xFileId_", e.RowIndex].Value != DBNull.Value)
                dvgxFileId_ = (int)dataGridView1["xFileId_", e.RowIndex].Value;
            else
                dvgxFileId_ = -1;
        ...
        //    uc_txtBoxType.Text = dataGridView1["xType", e.RowIndex].Value.ToString().Contains("E") ? "اضطراری" : "عادی";
            ...
            uc_txtBoxFileName.Text = dataGridView1["xFileName", e.RowIndex].Value.ToString();
        ...
        void CreateEmotions()
        {
            ...
            emotions.Add(":-)", MIS.Properties.Resources.labkhand);
            emotions.Add(":)", MIS.Properties.Resources.khande);
            emotions.Add(";-)", MIS.Properties.Resources.cheshmak);
            emotions.Add("X(", MIS.Properties.Resources.asabani);
            emotions.Add("B-)", MIS.Properties.Resources.abadan);
            emotions.Add("#-o", MIS.Properties.Resources.akh);
            emotions.Add("LIKE", MIS.Properties.Resources.like);
            emotions.Add(":((", MIS.Properties.Resources.cry);
            emotions.Add(":-(", MIS.Properties.Resources.narahat);
        ...
        {
            if (dvgxFileId_ > 0 && dataGridView1.SelectedCells.Count  > 0)
            {
                BLL.Message.csMessage cs = new BLL.Message.csMessage();

                DAL.Message.DataSet_Message.SlMessageFileDataTable dt = 
                    cs.SlMessageFile(dvgxFileId_) ;
            if (dt.Rows.Count > 0)
            {
                byte[] file = (byte[])dt.Rows[0]["xFile"];
                if (file == null)
                {
                ...
                savefile.FileName = uc_txtBoxFileName.Text;
