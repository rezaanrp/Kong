...
namespace MIS.MyControl.Chart
{
    public partial class uc_ChartInvCollect : UserControl
    {
        ...
        void SlInventoryForManager()
        {
            ...
            //  dt_SlInventoryForManager = cs.SlInventoryForManager(MIS.Properties.Settings.Default.WorkYear);
        ...
        void SlStockPiecesGrp()
        {
            ...
            //BLL.ManagerReport.csManagerReport cs = new BLL.ManagerReport.csManagerReport();
            //dt_SlStockPiecesGrp = cs.SlStockPiecesGrp(MIS.Properties.Settings.Default.WorkYear);
            //// MessageBox.Show("Finish");
        ...
        void SlInventoryScrab()
        {
            ...
            // dt_SlInventoryScrab = cs.SlInventoryScrab(MIS.Properties.Settings.Default.WorkYear, "1400/12/30", MIS.Properties.Settings.Default.WorkYear);
            //// MessageBox.Show("Finish");
        ...
        {
            //BLL.ManagerReport.csManagerReport cs = new BLL.ManagerReport.csManagerReport();
            // dt_SlInventoryAllMaterial = cs.SlInventoryAllMaterial(MIS.Properties.Settings.Default.WorkYear);
            //// MessageBox.Show("Finish");
        ...
        void ChartGenerate_5()
        {
            ...
            //
            DataTable dt = 
                new BLL.ClientReferral.csClientReferral().SlClientReferral_MoonReport(MIS.Properties.Settings.Default.WorkYear.Substring(0, 4));
            ...
            System.Windows.Forms.DataVisualization.Charting.Series series_1 =
                new System.Windows.Forms.DataVisualization.Charting.Series()
                {
                    ChartArea = "ChartArea1",
                    IsValueShownAsLabel = true,
                    LegendText = "امار مراجعین فروشگاه",
                    ...
                    LabelFormat = "##,#",
                    BackGradientStyle = System.Windows.Forms.DataVisualization.Charting.GradientStyle.DiagonalLeft,
                    BackSecondaryColor = System.Drawing.Color.Yellow,
                    BorderColor = System.Drawing.Color.White,
                    Color = System.Drawing.Color.Orange,
                    ShadowOffset = 2,
                    XValueMember = "MoonName",
                    YValueMembers = "CountClientReferral",
                    ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.Column,
                     IsVisibleInLegend = true
                };
            System.Windows.Forms.DataVisualization.Charting.Series series_2 =
                new System.Windows.Forms.DataVisualization.Charting.Series()
                {
                    ChartArea = "ChartArea1",
                    IsValueShownAsLabel = true,
                    LegendText = "تعداد فروش",
                    IsXValueIndexed = true,
                    LabelToolTip = "#VAL",
                    ToolTip = "#AXISLABEL",
                    XValueType = System.Windows.Forms.DataVisualization.Charting.ChartValueType.Double,
                    ...
                    ShadowOffset = 2,
                    XValueMember = "MoonName",
                    YValueMembers = "CountClientReferralSale",
                    ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.Column,
                     IsVisibleInLegend = true
            ...
            chart5.Titles["Title1"].Text = "امار مراجعین فروشگاه";
            ...
            //     DataTable dt = cs.SlMoldingDownTimeSumNodeByMonth(MIS.Properties.Settings.Default.WorkYear, tree_id,(int)CS.csEnum.Factory.Site1);
            //     progressBar_TL.Visible = false;
            ...
            //     BLL.ManagerReport.csManagerReport cs = new BLL.ManagerReport.csManagerReport();
            //     //DataTable dt = cs.SlInventoryForManager(Payazob.Properties.Settings.Default.WorkYear);
            //     DataTable dt;
        ...
        void ChartGenerate_BL()
        {
            ...
            // {
            //
            DataTable dt = new BLL.RealEstate.csRealEstate().SlDemandCountTanzimer(MIS.Properties.Settings.Default.WorkYear,
 MIS.Properties.Settings.Default.WorkYear.Substring(0, 4) + "/12/30");
            ...
            series_1.ChartArea = "ChartArea1";
            series_1.IsValueShownAsLabel = true;
            series_1.LegendText = "امار مراجعین به املاک";
            series_1.IsXValueIndexed = true;
            series_1.LabelToolTip = "#VAL";
            series_1.ToolTip = "#AXISLABEL";
            series_1.XValueType = System.Windows.Forms.DataVisualization.Charting.ChartValueType.Double;
            ...
            series_1.XValueMember = "tanzimer";
            series_1.YValueMembers = "Counttanzimer";
            series_1.ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.Column;
            chart_BL.ChartAreas[0].AxisY.IsStartedFromZero = true;
            this.chart_BL.Series.Add(series_1);
            chart_BL.Titles["Title1"].Text = "امار مراجعین به املاک";
            ...
            //     }
            //     BLL.ManagerReport.csManagerReport cs = new BLL.ManagerReport.csManagerReport();
            //    // DataTable dt = cs.SlStockPiecesGrp(Payazob.Properties.Settings.Default.WorkYear);
            //      DataTable dt;
        ...
        void ChartGenerate_BR()
        {
            ...
            // {
            DataTable dt = new BLL.RealEstate.csRealEstate().SlMainCountTanzimer(MIS.Properties.Settings.Default.WorkYear,
MIS.Properties.Settings.Default.WorkYear.Substring(0, 4) + "/12/30");
            ...
            series_1.ChartArea = "ChartArea1";
            series_1.IsValueShownAsLabel = true;
            series_1.LegendText = "امار ثبت ملک";
            series_1.IsXValueIndexed = true;
            series_1.LabelToolTip = "#VAL";
            series_1.ToolTip = "#AXISLABEL";
            series_1.XValueType = System.Windows.Forms.DataVisualization.Charting.ChartValueType.Double;
            ...
            chart_BR.Titles["Title1"].Text = "امار ثبت ملک";
            ...
            //     }
            //     //BLL.Inventory.csInventoryScrab cs = new BLL.Inventory.csInventoryScrab();
            //    // DataTable dt = cs.SlInventoryScrab(Payazob.Properties.Settings.Default.WorkYear, "1400/12/30", Payazob.Properties.Settings.Default.WorkYear);
            //     DataTable dt;
        ...
        {
            DataTable dt = new BLL.RealEstate.csRealEstate().SlMainCountTanzimerByDateDetails(new BLL.csshamsidate().previousDay(30), BLL.csshamsidate.shamsidate);
            ...
            series_1.ChartArea = "ChartArea1";
            series_1.IsValueShownAsLabel = true;
            series_1.LegendText = "  امار ثبت ملک به تفکیک روز";
            series_1.IsXValueIndexed = true;
            series_1.LabelToolTip = "#VAL";
            series_1.ToolTip = "#AXISLABEL";
            series_1.XValueType = System.Windows.Forms.DataVisualization.Charting.ChartValueType.Double;
            ...
            series_1.XValueMember = "DATE_";
            series_1.YValueMembers = "CountTanzimer";
            series_1.ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.Column;
            chart_T_R.ChartAreas[0].AxisY.IsStartedFromZero = true;
            this.chart_T_R.Series.Add(series_1);
            chart_T_R.Titles["Title1"].Text = "امار ثبت ملک به تفکیک روز";
            chart_T_R.Legends[0].Enabled = false;
