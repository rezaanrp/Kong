...
namespace ControlLibrary
{
    public partial class ucSubmenu : UserControl
    {
        ...
        MIS.MyControl.CustomToolTip customToolTip;
        ...
        private void btn_Click(object sender, EventArgs e)
        {
            ...
            st = st.Substring(4);
            MIS.CS.csOpenForm op = new MIS.CS.csOpenForm();
            MIS.Properties.Settings.Default.LsfEn = st;
            MIS.Properties.Settings.Default.LsfFa = ((System.Windows.Forms.Control)(sender)).Text.ToString();
        ...
        public void GenerateBtn(string TypeBtn)
        {
            ...
            foreach (DataRow drg in distinctValues.Rows)
            {
                ...
                btn_order();
                pupup = new ControlLibrary.PopUp.Popup(customToolTip = new MIS.MyControl.CustomToolTip());
